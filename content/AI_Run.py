...
def image_capture():
    ...
    image = cv2.resize(frame,(240,140),interpolation=cv2.INTER_AREA)
...
def image_transform():
    ...
    compress_image = cv2.resize(detect_custom.annotate_image,(240,140),interpolation=cv2.INTER_AREA)
